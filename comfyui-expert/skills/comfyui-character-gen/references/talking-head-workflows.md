...
import os
import sys
sys.path.append('{COMFYUI_PATH}/custom_nodes/SadTalker/src')
...
if __name__ == "__main__":
    ...
    pipeline.generate(
        source_image="{COMFYUI_PATH}/input/character_portrait.png",
        driven_audio="{COMFYUI_PATH}/input/character_dialogue.wav",
        output_path="{COMFYUI_PATH}/output/character_talking.mp4",
...
```json
{
  "1": {
    ...
    "inputs": {
      "image": "character_portrait.png"
    }
  },
  "2": {
    "class_type": "LoadAudio",
    "inputs": {
      "audio": "character_dialogue.wav"
    }
  },
  "3": {
...
import sys
sys.path.append('{COMFYUI_PATH}/custom_nodes/LivePortrait')
...
if __name__ == "__main__":
    ...
    generator.generate(
        source_image="{COMFYUI_PATH}/input/character.png",
        driving_audio="{COMFYUI_PATH}/input/dialogue.wav",
        output_path="{COMFYUI_PATH}/output/character_talking.mp4",
...
class Wav2LipPipeline:
    def __init__(self, wav2lip_path='{COMFYUI_PATH}/custom_nodes/Wav2Lip'):
...
if __name__ == "__main__":
    ...
    pipeline.apply_lipsync(
        video_path="{COMFYUI_PATH}/output/character_video_clip1.mp4",
        audio_path="{COMFYUI_PATH}/input/character_dialogue.wav",
        output_path="{COMFYUI_PATH}/output/character_lipsync_clip1.mp4",
        quality='improved',
        face_det_batch_size=16,
        wav2lip_batch_size=128,
        fps=25
...
class VideoVoicePipeline:
    ...
    def enhance_faces(self, video_path, output_path, fidelity=0.7):
        ...
        cmd = [
            'python',
            '{COMFYUI_PATH}/custom_nodes/CodeFormer/inference_codeformer.py',
            '-i', video_path,
            '-o', output_path,
...
# Example usage: Process five Character A video clips
if __name__ == "__main__":
    pipeline = VideoVoicePipeline()

    # Define your video/audio pairs
    clips = [
        ("output/character_clip1.mp4", "input/audio/character_dialogue1.wav", "character_01"),
        ("output/character_clip2.mp4", "input/audio/character_dialogue2.wav", "character_02"),
        ("output/character_clip3.mp4", "input/audio/character_dialogue3.wav", "character_03"),
        ("output/character_clip4.mp4", "input/audio/character_dialogue4.wav", "character_04"),
        ("output/character_clip5.mp4", "input/audio/character_dialogue5.wav", "character_05"),
    ]

    # Process all clips
    final_videos = pipeline.process_batch(
        video_audio_pairs=clips,
        output_dir="{COMFYUI_PATH}/output/character_final"
    )
...
1. **Concatenate clips** (if multiple):
   ```bash
   python {COMFYUI_PATH}/scripts/video/concat_videos.py
   ```
