...
**Good FLUX prompt:**
```
photorealistic portrait of a person with [hair description], [eye description], and
[distinctive facial features], wearing [wardrobe], sitting in [setting] with warm
ambient lighting, shallow depth of field, shot on Sony A7IV, 85mm lens
```
...
**Good SDXL prompt:**
```
masterpiece, best quality, char_token, photorealistic portrait of a person,
detailed skin texture, [eye description], [hair description],
...
### Wan 2.2 Video (legacy 2.1 prompting is similar)
...
**Good Wan prompt:**
```
the character talking naturally with gentle hand gestures,
...
```
char_token, photorealistic portrait, eyes visible, natural styling,
...
```
char_token, standing on a rooftop at sunset, wind blowing through their hair,
