...
> Validate fixes against `state/inventory.json`, `foundation/hardware-profile.md`, the exact
> error, and the installed ComfyUI/node versions. Flags and node names are not universal.
