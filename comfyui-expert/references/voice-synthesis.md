...
> `foundation/hardware-profile.md`, and current model/node version constraints.
...
tts.clone_voice("reference_audio.wav", voice_name="example_voice")

# Generate speech
tts.synthesize(
    text="This is a voice-synthesis test. *laughs*",
    voice="example_voice",
...
audio = model.generate(
    text="This is a voice-synthesis test.",
...
```
Describe the required acoustic and delivery qualities:
"A [tone] voice with [pace], [pitch], [accent if needed], and [delivery qualities]."
```
